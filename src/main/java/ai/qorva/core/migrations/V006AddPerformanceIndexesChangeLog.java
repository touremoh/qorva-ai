 ...
 * - CV:           {tenantId, tags}, {tenantId, score}
...
@Slf4j
@Component
@ChangeUnit(id = "V006AddPerformanceIndexesChangeLog", order = "006", author = "qorva")
public class V006AddPerformanceIndexesChangeLog extends AbstractQorvaDbMigration {
	...
	public void rollback(MongoDatabase db) {
		log.warn("Rolling back V006 – dropping performance indexes");
