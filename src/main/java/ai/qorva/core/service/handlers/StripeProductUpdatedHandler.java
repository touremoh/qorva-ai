...
@Slf4j
@Service
public class StripeProductUpdatedHandler implements StripeEventHandler {

	private final ProductReferenceService productReferenceService;

	@Autowired
	public StripeProductUpdatedHandler(ProductReferenceService productReferenceService) {
	...
	public void handle(StripeObject obj) throws QorvaException {
		...
		log.info("Handling product.updated stripeProductId={}", product.getId());
