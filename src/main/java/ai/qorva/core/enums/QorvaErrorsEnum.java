...
public enum QorvaErrorsEnum {
	...
	TOO_MANY_REQUESTS("429", HttpStatus.TOO_MANY_REQUESTS, QorvaErrorCodes.HTTP_TOO_MANY_REQUESTS),
	SERVICE_UNAVAILABLE("503", HttpStatus.SERVICE_UNAVAILABLE, QorvaErrorCodes.HTTP_SERVICE_UNAVAILABLE);
